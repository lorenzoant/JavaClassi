...
public class Polimorfismo {
    ...
    /*
     * 
     * Il polimorfismo permette di definire una classe madre (Figure) i cui elementi posso essere oggetti di classi differenti
     * in questo caso le varie figure geometriche
     * 
     */
    ...
    //f.den = 8;
		...
		java.util.List<Punto> lista2 = new ArrayList<Punto>();
		lista2.add(new Punto() );
		
		System.out.println(p.LocalizzaQuadrante()<=4 ? p.LocalizzaQuadrante() : "messaggio");*/
	}	
